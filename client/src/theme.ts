// * dark-mode를 위해서 컴포넌트마다 직접 넣는게 아닌 theme 변수들을 통한 처리가 필요하다.
...
function reverseTokens(tokensDark: Tokens): ReversedTokens {
...
export const tokensLight: ReversedTokens = reverseTokens(tokensDark);
